...
public class ChickenFrame extends JFrame{
	...
	public ChickenFrame(ChickenInfo[] chickenInfo, int num, OrderPanel op, SelectedMenuInfo selectedMenuInfo) {
		...
		String imagePath = chickenInfo[num].getChicken_image_link();
		menuNameLabel.setText(chickenInfo[num].getChicken_name());
		priceLabel.setText(dc.format(chickenInfo[num].getChicken_price()));
		infoLabel.setText(chickenInfo[num].getChicken_info());
