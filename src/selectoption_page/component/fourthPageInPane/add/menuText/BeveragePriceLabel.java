...
public class BeveragePriceLabel extends JLabel {

	public BeveragePriceLabel(BeverageInfo[] beverageInfo, int num) {
		setLocation(locationX(num), locationY(num));
		setSize(100, 15);
		setText(" "+"+"+String.valueOf(beverageInfo[num].getPrice()));
		try {
